...
`looper-scope` refuses vague goals but can't catch the run that is well-formed yet _wrong_ — it decomposes, it doesn't interrogate. Nonbeliever interrogates. Cheapest place to kill a bad run is before wave 1.

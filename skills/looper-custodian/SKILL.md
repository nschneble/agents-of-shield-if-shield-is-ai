...
Why the concurrency is removed rather than estimated, and what a clean check result does and does not buy, live in `references/phase-order-check.md` alongside the rest of the check's spec.
